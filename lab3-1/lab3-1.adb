...
F:G$Motor_Control$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llab3_1.getchar$c$1$10({1}SC:U),R,0,0,[]
...
S:G$flag$0$0({2}SI:U),E,0,0
S:G$counter$0$0({2}SI:U),E,0,0
S:Llab3_1.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:Llab3_1.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:Llab3_1.Steering_Servo$input$1$62({1}SC:U),R,0,0,[r7]
S:Llab3_1.Motor_Control$input$1$67({1}SC:U),R,0,0,[r7]
...
S:Flab3_1$__str_1$0$0({15}DA15d,SC:S),D,0,0
S:Flab3_1$__str_2$0$0({15}DA15d,SC:S),D,0,0
