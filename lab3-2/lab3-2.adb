...
S:Llab3_2.getchar$c$1$10({1}SC:U),R,0,0,[]
...
S:Llab3_2.ReadRanger$Data$1$143({2}DA2d,SC:U),E,0,0
S:Llab3_2.ReadRanger$range$1$143({2}SI:U),R,0,0,[]
S:Llab3_2.ReadRanger$addr$1$143({1}SC:U),R,0,0,[]
...
S:Flab3_2$__str_3$0$0({40}DA40d,SC:S),D,0,0
S:Flab3_2$__str_4$0$0({14}DA14d,SC:S),D,0,0
S:Flab3_2$__str_5$0$0({12}DA12d,SC:S),D,0,0
